...
if (CON.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'bot', fromMe: true, desc: Lang.PL_DESC }, async (message, match) => { 
    ...
    Asena.addCommand({ pattern: 'bot', fromMe: false, desc: Lang.PL_DESC }, async (message, match) => { 
